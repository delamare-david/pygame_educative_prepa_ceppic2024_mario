...
background = pygame.image.load("./assets/img/mEjjnZm-mario-wallpaper-hd.jpg").convert()
...
def mario_collision (left,top):
   ...
   if left <50 and top <70 :
      mario = pygame.image.load("./assets/img/3607831.png").convert_alpha()
